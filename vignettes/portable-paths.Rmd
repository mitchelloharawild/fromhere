...
Relative paths play a central role in portability, as they allow you to specify file locations relative to a known reference point (e.g., the project root) instead of using system-specific absolute paths. This allows file paths to work on any system, which allows others to reproduce your work without modifying file paths.
...
Consider the R project "my-awesome-project", which has been saved to the John's Documents folder ( `"/Users/John/Documents/"`). It has the following contents:
